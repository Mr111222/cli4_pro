    ...
    children: [
      {
        ...
        name: "Element1",
        component: () =>
          import(/* webpackChunkName: "Element1" */ "../views/test/test1.vue"),
        meta: {
          title: "Element1"
        }
      },
      {
        ...
        name: "Element2",
        component: () =>
          import(/* webpackChunkName: "Element2" */ "../views/test/test2.vue"),
        meta: {
          title: "Element2"
        }
      },
      {
        ...
        name: "Element3",
        component: () =>
          import(/* webpackChunkName: "Element3" */ "../views/test/test3.vue"),
        meta: {
          title: "Element3"
        }
      },
