...
export default {
  ...
  computed: {
    ...
    isMenuPopup() {
      console.log(this.rootMenu.isMenuPopup, 9999);
    ...
    isFirstLevel() {
      ...
      while (parent && parent !== this.rootMenu) {
        if (
          ["ZzSubmenu", "ZzMenuItemGroup"].indexOf(
      ...
      <transition name={menuTransitionName}>
        ...
        >
          <ul
            role="menu"
            class={[
              "zz-menu zz-menu--popup",
              `zz-menu--popup-${currentPlacement}`
            ]}
